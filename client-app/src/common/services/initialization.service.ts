...
import { faHeartBroken, faLock, faMeteor, faThLarge, faList, faShoppingCart } from '@fortawesome/free-solid-svg-icons';
...
export default class InitializationService {
  static initializeCommon() {
    ...
    library.add(faHeartBroken, faLock, faMeteor, faThLarge, faList, faShoppingCart);
    dom.watch();
